...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51P1TYzSAKshd6c1qwpzhWYcCNkxSMRf5ZveK0Fqwwt58HYz89mYMp0FeL9y6tSf9EEqaq4KaV1KA6mFMrHQtb6BW00XkRvyJgX"
  );
  ...
  //managing the routing configuration for the application.
  const router = createBrowserRouter(
    // create route from the elements passed to it.
    createRoutesFromElements(
      //defines a route component that matches all paths "/" and render the main component
